...
public class InTotoWrapper extends SimpleBuildWrapper {
    ...
    public void setUp(SimpleBuildWrapper.Context context,
        ...
        linkBuilder.setBasePath(workspace.getRemote()).addMaterial(Arrays.asList(""));
    ...
    public static class PostWrap extends Disposer {
        ...
        public void tearDown(Run<?,?> build,
            ...
            this.linkBuilder.setBasePath(workspace.getRemote()).addProduct(Arrays.asList(""));
            Metablock<Link> metablock = new Metablock<>(this.linkBuilder.build(), null);
            if (this.key != null) {
            	metablock.sign(key);
            } else {
